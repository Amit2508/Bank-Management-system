...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    JButton next;
    JComboBox<String> religion, income, occupation, category, education;
    String formno;
    ...
    SignupTwo(String formno) {
        ...
        String valReligion[] = { "Hindu", "Sikh", "Chrisitian", "Muslim", "Other" };
        ...
        String incomevCategory[] = { "Null", "< 1,50,000", "<2,50,000", "5,00,000", "Upto 10,00,000" };
        income = new JComboBox<>(incomevCategory);
        ...
        String occupationValues[] = { "Job", "Self-Employed", "Buissness", "student", "Retired", "others" };
...
//        String formno = "" + new Random().nextInt(1000000);
